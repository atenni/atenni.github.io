...
<PrintedPageWrapper
  ...
  **While my most recent responsibilities have centred around engineering
  ...
  The one common thread throughout my career has been _the application of
  technical solutions to business & user problems,_ and this continues to inform
  the work that I do – I'm passionate about the user experience, and
  ...
  - **Founder** • 2018—present • _Malalta [^2]_
    ...
    inline with client budgets, collaborating with remote teammates, reviewing
    and providing feedback on pull requests, and a lot of time management.
  ...
  - **Director of Strategy** • 2018 • _Alphacrucis University College [^3]_
    ...
    planning process in partnership with the CEO. I didn't do much _software
    development_ work this year, but am happy to talk about the role in more
  ...
  - **Chief Information Officer** • 2010—2017 • _Alphacrucis University College_
    ...
    1. _Implementing a CI/CD pipeline for deploying various website to
       production._ Tools: GitHub Workflows and AWS.
    3. _Writing several internal business tools in TypeScript and Python to
       ...
       REST, GraphQL, and browser automation.
    4. _Writing numerous integrations between various platforms._ Tools: AWS
    ...
    2. _Championing various code-quality initiatives_, such as: migrating to
       TypeScript, adoption of Python type hints, GitHub pull request work flow,
       and automated testing in CI/CD.
  ...
  - **Self employed musician & freelance web developer** • 1996—2007
    ...
    While at University and for a few years after I worked primarily as a
  ...
  - **Tutor: Music Theory / Aural / Guitar** • 2002—2004 • _Australian
    ...
    to individual students who interested in majoring in performance as part of
    their degree.
